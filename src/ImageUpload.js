                    ...
                    <form className="imageupload__commentAssign">
                        ...
                        <div className="imageupload__secondSectionModal">
                            <Avatar
                                ...
                                alt=""
                            />
                            <input type="text" onChange={(e) => setCaption(e.target.value)} onClick={handleOpen} placeholder={`¿En que estas pensando ${username} ?`} />
                        </div>
                        <hr />
                        ...
                        <div className="imageupload__feedModal">
                            ...
                            <h3>News Feed</h3>
                            <br />
                            <h2 className={`imageText ${image && 'show'}`}>La imagen sera publicada despues de dar click</h2>
